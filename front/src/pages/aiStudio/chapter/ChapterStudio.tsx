...
import NovelCodexPanel from './components/NovelCodexPanel'
    ...
    <div className={['cs-studio w-full h-full min-h-0 flex flex-col', isResizing ? 'cs-resizing' : ''].join(' ')} ref={containerRef}>
      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          {chapterId && <NovelCodexPanel chapterId={chapterId} onComplete={() => { loadShots() }} />}
...
function Inspector(props: {
 ...
 const [keyframePromptActionLoading, setKeyframePromptActionLoading] = useState(false)
  ...
  const [pipelineProgressOpen, setPipelineProgressOpen] = useState(false)
